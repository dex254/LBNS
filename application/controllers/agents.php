...
class agents extends CI_Controller {
	...
	public function index()
	{
		...
		$data['agents'] = $this->lbns_model->get_all_data('agents');
	...
	public function create()
	  ...
	  public function store()
	    ...
	    $this->load->library('form_validation');
			...
			$this->form_validation->set_rules('size', 'Quantity', 'required');
			$this->form_validation->set_rules('number', 'Amount', 'required');
	    ...
	    if ($this->form_validation->run() === FALSE)
	        ...
	        $userRegId=$this->lbns_model->insert_data('agents', $dataagents);
